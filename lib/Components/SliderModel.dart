...
List<SliderModel> getSlides(){
  ...
  sliderModel.setImageAssetPath("lib/illustration.png");
  ...
  sliderModel.setImageAssetPath("lib/illustration2.png");
  slides.add(sliderModel);
  ...
  sliderModel.setImageAssetPath("lib/illustration3.png");
  slides.add(sliderModel);
